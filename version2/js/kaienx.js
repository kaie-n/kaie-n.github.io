...
$(window).load(function () {
    ...
    var text = ["video", "event", "wedding", "engagement", "web design", "animation", "logo", "photography", "application"];
    var counter = 0;
        ...
        var t_data = $.getJSON(api + "posts/video?callback=?&filter=video&limit=20&offset=" + offset + "&" + key, function (data) {
            $.each(data.response.posts, function (i, item) {
                ...
                $.getJSON('http://www.vimeo.com/api/v2/video/' + numb + '.json?callback=?', { format: "json" }, function (data) {
                    $("#video-gallery").append('<div class="col-md-2"><a class="item" href="' + source_id + '"><img src="' + data[0].thumbnail_large + '" style="width:100%;"></a></div>')
